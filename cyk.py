"""Loads a CNF grammar, reads in the example sentences, and for each example
sentence, outputs the following to a file:
...
Args:
    sys.argv[1]: name of the file holding grammar rules in the NLTK .cfg format in Chomsky Normal Form
    sys.argv[2]: name of the file containing test sentences to parse with CKY algorithm
Returns:
    sys.argv[3]: name of the file where system will write the parses and their counts over the test sentences
"""
